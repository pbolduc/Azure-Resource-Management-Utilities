...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class SiteAuthSettings
    {
        ...
        public SiteAuthSettings(bool? enabled = default(bool?), string runtimeVersion = default(string), UnauthenticatedClientAction? unauthenticatedClientAction = default(UnauthenticatedClientAction?), bool? tokenStoreEnabled = default(bool?), System.Collections.Generic.IList<string> allowedExternalRedirectUrls = default(System.Collections.Generic.IList<string>), BuiltInAuthenticationProvider? defaultProvider = default(BuiltInAuthenticationProvider?), double? tokenRefreshExtensionHours = default(double?), string clientId = default(string), string clientSecret = default(string), string issuer = default(string), System.Collections.Generic.IList<string> allowedAudiences = default(System.Collections.Generic.IList<string>), System.Collections.Generic.IList<string> additionalLoginParams = default(System.Collections.Generic.IList<string>), string googleClientId = default(string), string googleClientSecret = default(string), System.Collections.Generic.IList<string> googleOAuthScopes = default(System.Collections.Generic.IList<string>), string facebookAppId = default(string), string facebookAppSecret = default(string), System.Collections.Generic.IList<string> facebookOAuthScopes = default(System.Collections.Generic.IList<string>), string twitterConsumerKey = default(string), string twitterConsumerSecret = default(string), string microsoftAccountClientId = default(string), string microsoftAccountClientSecret = default(string), System.Collections.Generic.IList<string> microsoftAccountOAuthScopes = default(System.Collections.Generic.IList<string>))
        {
            Enabled = enabled;
