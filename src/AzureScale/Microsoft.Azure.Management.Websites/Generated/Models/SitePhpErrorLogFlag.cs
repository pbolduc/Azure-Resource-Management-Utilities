...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class SitePhpErrorLogFlag : Resource
    {
        ...
        /// setting.</param>
        public SitePhpErrorLogFlag(string location, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string localLogErrors = default(string), string masterLogErrors = default(string), string localLogErrorsMaxLength = default(string), string masterLogErrorsMaxLength = default(string))
