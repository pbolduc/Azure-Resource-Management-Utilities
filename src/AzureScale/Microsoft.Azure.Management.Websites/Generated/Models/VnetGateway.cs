...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class VnetGateway : Resource
    {
        ...
        /// downloaded.</param>
        public VnetGateway(string location, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string vnetName = default(string), string vpnPackageUri = default(string))
