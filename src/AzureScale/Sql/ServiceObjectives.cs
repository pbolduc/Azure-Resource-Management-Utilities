namespace AzureScale.Sql
{
    ...
    public static class ServiceObjectives
    {
        ...
        public static ServiceObjective Next(IList<ServiceObjective> collection, ServiceObjective serviceObjective)
        {
            for (int i = 0; i < collection.Count; i++)
            {
                if (collection[i].Id == serviceObjective.Id)
                {
        ...
        public static ServiceObjective Previous(IList<ServiceObjective> collection, ServiceObjective serviceObjective)
        {
            for (int i = 0; i < collection.Count; i++)
            {
                if (collection[i].Id == serviceObjective.Id)
