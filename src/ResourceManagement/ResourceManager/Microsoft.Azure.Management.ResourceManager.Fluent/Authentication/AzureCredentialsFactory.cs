...
namespace Microsoft.Azure.Management.Resource.Fluent.Authentication
{
    ...
    public class AzureCredentialsFactory
    {
        ...
        public AzureCredentials FromCertificate(string tenant, string clientId, X509Certificate2 certificate, AzureEnvironment environment)
        {
            return new AzureCredentials(new CertificateLoginInformation(clientId, certificate), tenant, environment);
        }
